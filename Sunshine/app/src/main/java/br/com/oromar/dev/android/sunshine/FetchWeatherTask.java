...
public class FetchWeatherTask extends AsyncTask<String, Void, Void> {
    ...
    public FetchWeatherTask(Context context, int loaderId, ForecastFragment fragmentInstance, View fragmentView, SwipeRefreshLayout containerSwipeRefreshLayout) {
        mContext = context;
        mLoaderId = loaderId;
    ...
    protected Void doInBackground(String... params) {
        ...
        Cursor cur = mContext.getContentResolver().query(weatherUri, ForecastAdapter.FORECAST_COLUMNS, null, null, sortOrder);
