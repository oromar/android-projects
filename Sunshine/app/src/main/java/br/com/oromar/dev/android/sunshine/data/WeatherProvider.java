...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            ...
            default:{
                throw new android.database.SQLException("Failed to delete. Cannot find uri: " + uri);
            }
        }
    ...
    public int update(
        ...
        switch (match){
            ...
            default:{
                throw  new android.database.SQLException("Failed to update. Cannot find uri: " + uri);
            }
        }
        getContext().getContentResolver().notifyChange(uri, null);
        db.close();
